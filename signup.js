// signup.js — GİRİŞ ve KAYIT tek sayfada (Firebase Web v10)
  ...
  try{
    ...
    $("signupBtn").addEventListener("click", async () => {
      ...
      try{
        ...
        await sendEmailVerification(cred.user);  // ÖZEL URL YOK → Firebase varsayılan link
