// Basit koruma (eklenti kapatmaya gerek yok, CSS yetiyor)
(function () { try { document.body.contentEditable = "false"; document.designMode = "off"; } catch (_) {} })();
...
$("btnSignup").addEventListener("click", async () => {
  ...
  try {
    ...
    $("tabLogin").click(); $("loginEmail").value = email;
  } catch (e) { msg(t(e.code)); }
});
